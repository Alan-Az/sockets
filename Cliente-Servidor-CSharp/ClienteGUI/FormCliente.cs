...
public class FormCliente : Form
{
    ...
    // Paleta de colores explícita de alto contraste para Linux / Windows GTK
    private static readonly Color ColorFondoPanel = Color.FromArgb(241, 245, 249);
    private static readonly Color ColorFondoInput = Color.FromArgb(255, 255, 255);
    private static readonly Color ColorTextoInput = Color.FromArgb(15, 23, 42);
    private static readonly Color ColorTextoEtiqueta = Color.FromArgb(30, 41, 59);
    ...
    public FormCliente()
    {
        ...
        BackgroundColor = ColorFondoPanel;

        // UI Controls con colores explícitos (evita texto blanco sobre fondo blanco en Linux GTK)
        txtHost = new TextBox
        {
            Text = "127.0.0.1",
            Width = 110,
            BackgroundColor = ColorFondoInput,
            TextColor = ColorTextoInput
        };
        ...
        // Labels
        var lblHost = new Label { Text = "Host:", TextColor = ColorTextoEtiqueta };
        var lblPuerto = new Label { Text = "Puerto:", TextColor = ColorTextoEtiqueta };
        var lblUsuario = new Label { Text = "Usuario:", TextColor = ColorTextoEtiqueta };
